...
1.  create two separate customer segmentations (using clustering) to split them into 3-5 clusters: 
    - BEN - based on demographics (only on the information from twm_customer)
    - BRITTANY - based on their banking behavior. We can take following things 
    into consideration as banking behavior:
